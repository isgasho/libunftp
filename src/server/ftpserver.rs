    ...
    S::Metadata: storage::Metadata,
{
    ...
    async fn spawn_control_channel_loop(&self, tcp_stream: tokio::net::TcpStream, connection: Option<ConnectionTuple>, callback_msg_tx: Option<Sender<ProxyProtocolCallback>>) -> Result<(), FTPError> {
